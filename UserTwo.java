...
public class UserTwo implements ActionListener, Runnable {                                  // Define a class called 'UserTwo' that can handle user actions and run in a separate thread.
    ...
    UserTwo() {                       // Constructor for the UserTwo class that sets up the GUI and establishes a connection with the server.
        ...
        f.setLocation(650, 50);                                  // Set the position of the JFrame on the screen (x: 490px, y: 50px).
    ...
    public static void main(String[] args) {                       // The main method that starts the program.
        UserTwo two = new UserTwo();                               // Create an instance of the UserTwo class.
        Thread t1 = new Thread(two);                               // Create a new thread to run the chat reading loop.
